...
import { IconEdit, IconDelete, IconDownload, IconEye, IconArrowRight } from '@arco-design/web-react/icon';
const Row = Grid.Row
const Col = Grid.Col
          ...
          <Col span={11} offset={1}>
            ...
            >
              ...
              <Select
                ...
                placeholder="please enter"
                onChange={(e) => {
                  setHospitalityCourseVal(e);
                }}
              />
            </Form.Item>
            <Form.Item
              label={'Worklife Course'}
              field="WorklifeCoursesID"
            >
